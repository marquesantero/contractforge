...
dbutils.widgets.text("bundle_root", "/Workspace/Shared/contractforge-examples/USGS_REST_Medallion/files")
dbutils.widgets.text("contract", "")
dbutils.widgets.text("evidence_catalog", "workspace")
dbutils.widgets.text("evidence_schema", "cf_usgs_rest_ops")
