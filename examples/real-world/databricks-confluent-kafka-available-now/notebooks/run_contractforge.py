...
dbutils.widgets.text("bundle_root", "/Workspace/Shared/contractforge-examples/Databricks_Kafka_Available_Now/files")
dbutils.widgets.text("contract", "")
dbutils.widgets.text("evidence_catalog", "workspace")
dbutils.widgets.text("evidence_schema", "cf_databricks_kafka_contract_ops")
...
result = ingest_databricks_bundle(
    ...
    options=DatabricksIngestOptions(
        ...
        run_id=run_id,
        runtime_metadata={"runtime_type": "serverless", "deployment": "databricks_job_contract_runtime"},
    ),
