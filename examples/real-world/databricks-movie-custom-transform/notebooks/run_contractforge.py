...
dbutils.widgets.text("bundle_root", "/Workspace/Shared/contractforge-examples/Movie_Custom_Transform/files")
dbutils.widgets.text("contract", "")
dbutils.widgets.text("evidence_catalog", "workspace")
dbutils.widgets.text("evidence_schema", "cf_movie_ops")
