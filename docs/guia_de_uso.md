...
pip install build
python -m build
# gera: dist/lakehouse_ingestion_framework-1.5.1-py3-none-any.whl
```
...
2. Source: **Volume**
3. File path: `/Volumes/<catalog>/<schema>/libs/lakehouse_ingestion_framework-1.5.1-py3-none-any.whl`
4. Install
...
print(lakehouse_ingestion.__version__)  # 1.5.1
...
```python
%pip install --index-url https://<seu_pypi_privado> lakehouse-ingestion-framework==1.5.1
```
