...
def _add_contract_parsers(subparsers: Any) -> None:
    ...
    resolve_bundle = subparsers.add_parser("resolve-bundle", help="Print split contract bundles after project defaults and safe inference")
    resolve_bundle.add_argument("paths", nargs="+", type=Path)
    resolve_bundle.add_argument("--indent", type=int, default=2)
